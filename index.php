         ...
         if(!empty($login_err)){
          ...
          ?>
                            <div class="form-group mt-1 mb-2">
                                <p class="m-0 ml-2 mb-2 p-0 f-14 font-weight-bold">Email</p>
                                <input type="text" class="form-control login-screen-input f-14 <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>" name="username" placeholder="Enter your email" />
                                <span class="invalid-feedback"><?php echo $username_err; ?></span>
                            </div>
                            <div class="form-group mt-4 mb-2">
                                <p class="m-0 ml-2 mt-2 mb-2 p-0 f-14 font-weight-bold">
                                    Password
                                </p>
                                <input type="password" class="form-control login-screen-input f-14  <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" name="password" placeholder="********" />
                                <span class="invalid-feedback"><?php echo $password_err; ?></span>
                            
                            </div>
                            <div class="form-group mt-4 mb-0">
                                <div class="row mx-1">
                                    <div class="col-6 pl-1 d-flex align-items-center">
                                        <input type="checkbox" id="exampleCheck1" />
                                        <label class="m-0 ml-2 p-0 f-12 font-weight-bold">Remember me?</label>
                                    </div>
                                    <div class="col-6 pr-1 text-right">
                                        <label class="m-0 ml-2 p-0 f-12 font-weight-bold curPoint">Forgot Password?</label>
                                    </div>
                                </div>
                            </div>
                            <div class="ml-2">
                            ...
                            <div class="form-group mt-2 mb-0">
                                    ...
                                    <button class="signIn-button curPoint">Sign in</button>
